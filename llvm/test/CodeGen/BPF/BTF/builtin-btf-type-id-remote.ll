...
; CHECK-BTF-NEXT: [3] FUNC 'prog1' type_id=1 linkage=global
; CHECK-BTF-NEXT: [4] INT 'char' size=1 bits_offset=0 nr_bits=8 encoding=SIGNED
; CHECK-BTF-NEXT: [5] FUNC_PROTO '(anon)' ret_type_id=2 vlen=0
; CHECK-BTF-NEXT: [6] FUNC 'prog2' type_id=5 linkage=global
; CHECK-BTF-NEXT: [7] PTR '(anon)' type_id=8
; CHECK-BTF-NEXT: [8] CONST '(anon)' type_id=4
; CHECK-BTF-NEXT: [9] FUNC_PROTO '(anon)' ret_type_id=2 vlen=0
; CHECK-BTF-NEXT: [10] FUNC 'prog3' type_id=9 linkage=global
; CHECK-BTF-NEXT: [11] PTR '(anon)' type_id=0
...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "clang version 23.0.0git (https://github.com/llvm/llvm-project.git ec6a219fc3627eebdbfbb934230aa843a823aee0)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, retainedTypes: !2, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "test.c", directory: "/tmp/home/yhs/tmp/tmp3", checksumkind: CSK_MD5, checksum: "fa68707a49f823b3013ef8dab0a0c59b")
!2 = !{!3}
...
!8 = !{!"clang version 23.0.0git (https://github.com/llvm/llvm-project.git ec6a219fc3627eebdbfbb934230aa843a823aee0)"}
!9 = !{!10, !10, i64 0}
!10 = !{!"int", !11, i64 0}
