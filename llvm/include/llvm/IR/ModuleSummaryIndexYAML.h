...
struct GlobalValueSummaryYaml {
  ...
  bool NotEligibleToImport, Live, IsLocal, CanAutoHide, PromotingFuncName;
  unsigned ImportType;
...
template <> struct MappingTraits<GlobalValueSummaryYaml> {
  static void mapping(IO &io, GlobalValueSummaryYaml &summary) {
    ...
    io.mapOptional("PromotingFuncName", summary.PromotingFuncName);
      ...
      for (auto &Sum : P.second.getSummaryList()) {
        if (auto *FSum = dyn_cast<FunctionSummary>(Sum.get())) {
          ...
          GVSums.push_back(GlobalValueSummaryYaml{
              ...
              static_cast<bool>(FSum->flags().PromotingFuncName),
          ...
          GVSums.push_back(GlobalValueSummaryYaml{
              ...
              static_cast<bool>(ASum->flags().PromotingFuncName),
